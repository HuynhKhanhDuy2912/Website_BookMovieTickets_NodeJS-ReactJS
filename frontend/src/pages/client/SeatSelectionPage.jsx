...
export default function SeatSelectionPage() {
   ...
   const calculateTotal = () => {
      ...
      const vipSurcharge = 20000; // Phụ thu VIP (Phải khớp với Backend)

      return selectedSeats.reduce((total, seatNum) => {
         // Tìm thông tin ghế trong room config để biết nó là VIP hay thường
         ...
         <div className="flex-1 p-4 overflow-auto flex justify-center">
            <div className="w-full max-w-4xl flex flex-col items-center">
               ...
               <div className="flex gap-4 mt-12 text-sm text-gray-400 justify-center flex-wrap">
                  ...
                  <div className="flex items-center gap-2"><div className="w-5 h-5 bg-gray-800 border border-orange-500 rounded"></div> VIP (phụ thu 20.000đ)</div>
